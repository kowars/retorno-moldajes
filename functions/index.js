...
// Definir router con todas las rutas
...
r.put('/formwork/:id', async (req, res) => {
  const { id } = req.params;
...
r.delete('/formwork/:id', async (req, res) => {
...
// DISPATCHES
r.get('/dispatches', async (_req, res) => {
...
r.get('/dispatches/:id', async (req, res) => {
...
r.post('/dispatches', async (req, res) => {
...
// Montar router en '/' y también en '/api'
app.use('/', r);
app.use('/api', r);
